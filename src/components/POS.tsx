...
import { ShoppingCart, Plus, Minus, Trash2, Search, User, Printer, CheckCircle } from 'lucide-react';
    ...
    printWindow.document.write(`
      <html>
        <head>
          ...
          <style>
            body { font-family: 'Arial', sans-serif; padding: 20px; color: #333; line-height: 1.4; max-width: 300px; margin: 0 auto; }
            .header { text-align: center; border-bottom: 2px solid #EEE; padding-bottom: 10px; margin-bottom: 15px; }
            .footer { text-align: center; border-top: 2px solid #EEE; padding-top: 10px; margin-top: 15px; font-size: 12px; }
            table { width: 100%; border-collapse: collapse; }
            .total { font-weight: bold; font-size: 18px; border-top: 1px solid #EEE; padding-top: 10px; }
            .meta { font-size: 12px; color: #666; margin-bottom: 10px; }
          </style>
        </head>
        <body>
          <div class="header">
            <h2 style="margin:0">${settings.systemName}</h2>
            <div style="font-size: 12px;">${settings.receiptHeader || ''}</div>
          </div>
          <div class="meta">
          ...
          <div class="footer">
            ...
            <div style="margin-top: 5px; font-size: 10px; color: #999;">Generated by ${settings.systemName}</div>
          </div>
        ...
        <div className="fixed bottom-8 left-1/2 -translate-x-1/2 bg-emerald-600 text-white px-6 py-4 rounded-2xl shadow-2xl z-50 flex items-center gap-6 animate-in slide-in-from-bottom-8">
          ...
          <div className="flex gap-2">
            <button 
              ...
              className="px-4 py-2 bg-white text-emerald-600 rounded-lg font-bold text-sm hover:bg-slate-50 transition-colors flex items-center gap-2"
            >
